...
local sets = {
    TP_Priority = {
        Main = {'Centurion\'s Axe', 'Neckchopper', 'Moth Axe', 'Greataxe', 'Butterfly Axe'},
        Head = {'Ryl. Squire\'s Helm', 'Beetle Mask +1', 'Ryl.Ftm. Bandana'},
        ...
        Body = {'Ctr. Scale Mail', 'Beetle Harness +1', 'Angler\'s tunica', 'Ryl.Ftm. Vest'},
        Hands = {'Custom F Gloves', 'Ryl.Ftm. Gloves'},
        ...
        Feet = {'Ctr. Greaves', 'Ryl.Ftm. Boots'},
        Range = 'Lgn. Crossbow',
        Ammo = 'Crossbow Bolt'
    },
    WS_Priority = {
...
profile.SetMacroBook_WAR = function()
...
profile.OnLoad = function()
    profile.SetMacroBook_WAR();
    profile.Keybinds_WAR();
